...
export default function Calendar() {
  ...
  return (
    <LayoutPage title="Calendário" subtitle="Veja todos os jogos por jornada" extraHeader={
        ...
        <div className="space-y-5">
          {jogosSelecionados.map((jogo) => {
            ...
            return (
              ...
              >
                {/* Cabeçalho do Card - Informações do Jogo */}
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="px-8 text-center">
                      {isRealizado ? (
                        <div>
                          <div className="bg-linear-to-br from-blue-600 to-blue-700 text-white px-8 py-4 rounded-2xl shadow-lg mb-3">
                            <p className="text-4xl font-black tracking-wider">{jogo.resultado}</p>
                          </div>
